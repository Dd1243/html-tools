const fs = require('fs');
const h = fs.readFileSync('tools/generator/htaccess-generator.html', 'utf8');
...
console.log('has_canonical=', h.includes('essays4u.net/tools/generator/htaccess-generator'));
