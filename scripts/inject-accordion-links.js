...
function generateAccordionHTML(currentToolId) {
  ...
  let html = `
      <!-- 折叠手风琴式工具导航 - 自动生成 -->
      <section style="max-width: 1200px; margin: 2.5rem auto; padding: 2rem; background: var(--bg-card, var(--card, #fff)); border: 1px solid var(--border-color, var(--border, #e2e8f0)); border-radius: var(--radius-lg, var(--radius, 12px)); box-shadow: 0 4px 24px rgba(0, 0, 0, 0.08);">
